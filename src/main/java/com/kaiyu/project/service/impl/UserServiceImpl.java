...
import static com.kaiyu.project.constant.UserConstant.ADMIN_ROLE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 4. 插入数据
            User user = new User();
            user.setUserAvatar("https://oss.aliyuncs.com/aliyun_id_photo_bucket/default_handsome.jpg");
    ...
    @Override
    public boolean updateAkSk(int id,String userAccount, HttpServletRequest request) {
